...
import 'package:near_expiry_driver/http-service/api_response.dart';
import 'package:near_expiry_driver/http-service/http-service.dart';
import 'package:near_expiry_driver/locator/locator.dart';
import 'package:near_expiry_driver/utils/api-constant.dart';
...
class LoginRepository{
  ...
  Future<ApiResponse<DriverLogin?>> userLogin(String userName, String password,) async {

    var apiResponse = await _httpService.postRequest(ApiConstant.SERVER+ApiConstant.DRIVER_LOGIN,
        data: {
          "userName":userName,
          "password":password,
    ...
    return ApiResponse(
        ...
        data:DriverLogin.fromJson(apiResponse.data.data)
    );
